...
<body>
    ...
    <div class="main-body wow fadeIn">
        ...
        <table class="table settings" style="margin-top: 20px !important;">
            <tr>
                <td class="settings-name">Old Password</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
            <tr>
                <td class="settings-name">New Password</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
            <tr>
                <td class="settings-name">Confirm New Password</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
            <tr>
                <td class="settings-name">Security Question</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
