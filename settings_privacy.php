...
<body>
    ...
    <div class="main-body wow fadeIn">
        ...
        <table class="table settings" style="margin-top: 20px !important;">
            <tr>
                <td class="settings-name">Who can see your future posts?</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
            <tr>
                <td class="settings-name">Who can contact me?</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
            <tr>
                <td class="settings-name">Who can send friend request?</td>
                <td class="text-right">
                    <span class="material-icons"><a href="#" class="edit">edit</a></span>
                </td>
            </tr>
