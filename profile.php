...
<body>
    ...
    <div class="side-bar-profile">
            ...
            <ul class="nav profile-nav">
                <li class="wow fadeInUp" data-wow-delay=".2s">
                    <ul class="list-inline inline">
                        <li><span class="material-icons">location_on</span></li>
                        <li>Lives in New York, USA</li>
                    </ul>
                </li>
                <li class="wow fadeInUp" data-wow-delay=".4s">
                    <ul class="list-inline inline">
                        <li><span class="material-icons">location_on</span></li>
                        <li>From New York, USA</li>
                    </ul>
                </li>
                <li class="wow fadeInUp" data-wow-delay=".6s">
                    <ul class="list-inline inline">
                        <li><span class="material-icons">done_all</span></li>
                        <li>Followed by 344 People</li>
                    </ul>
                </li>
                <li class="wow fadeInUp" data-wow-delay=".8s">
                    <ul class="list-inline inline">
                        <li><span class="material-icons">phone</span></li>
                        <li>012-345-6789</li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="col-md-12 profile-img-section wow fadeInDown">
            <ul class="list-inline inline profile-nav side-panel-heading">
                <li><span class="material-icons">photo</span></li>
                <li style="padding-left: 0px;">Photos</li>
            </ul>
            <div class="col-sm-4 side-panel-images">
                <a href="#"><img src="img/profile-img.png" class="img-responsive" alt=""></a>
            </div>
            <div class="col-sm-4 side-panel-images">
                <a href="#"><img src="img/profile-img.png" class="img-responsive" alt=""></a>
            </div>
        ...
        <div class="col-md-12 profile-img-section wow fadeInDown">
            <ul class="list-inline inline profile-nav side-panel-heading">
                ...
                <li style="padding-left: 0px;">Friends - <small>231</small></li>
            </ul>
            <div class="col-sm-4 side-panel-images relative">
                <a href="#"><img src="img/profile-img.png" class="img-responsive" alt="">
                    <span class="friend-name">Name</span></a>
            </div>
            <div class="col-sm-4 side-panel-images relative">
                <a href="#"><img src="img/profile-img.png" class="img-responsive" alt=""><span class="friend-name">Name</span></a>
            </div>
            <div class="col-sm-4 side-panel-images relative">
                <a href="#"><img src="img/profile-img.png" class="img-responsive" alt=""><span class="friend-name">Name</span></a>
            </div>
