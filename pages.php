    ...
    <div class="main-body wow fadeIn">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-8 text-right">
                    <ul class="list-inline" style="margin-top: 12px;">
                        <li><a href="#" class="text-blue" style="margin-right: 20px;">Your Pages</a></li>
                        <li><a href="create_page.php" class="text-blue">Create Page</a></li>
                    </ul>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-inline inline">
                        <li><img src="img/profile-img-lg.png" class="profile-img-lg" alt=""></li>
                        <li>
