            ...
            <div class="row">
                ...
                <div class="col-sm-8 text-right">
                    <ul class="list-inline" style="margin-top: 12px;">
                        <li><a href="#" class="text-blue" style="margin-right: 20px;">Your Groups</a></li>
                        <li><a href="create_page.php" class="text-blue">Create Group</a></li>
                    </ul>
                </div>
            </div>
            <hr>
